...
```{r}
nav_df =  read_csv("./LoadSpeed_Wifi.csv", col_names = TRUE)
...
```{r}
ggplot(data.frame(y = nav_df$batteryStatsAvg), aes(x = nav_df$loadMean, y=y, sample = y, color = nav_df$performanceLvl)) +
...
There is an improvement in data skewness for the reciprocal of energy efficiency, in comparison to raw values. Data is negatively skewed in this case.
...
Data is positively skewed in this case. There is an improvement in data skewness for the log of energy efficiency, in comparison to raw values. However, the reciprocal of energy efficiency is less skewed.
