...
**As a result, we consider the raw energy efficiency when performing statistical tests to test the hypothesis. We can perform parametric tests in this case, taking into account the observations and the results of the Shapiro-Wilk test in regards to normality. In terms of skewness, we consider 0.65 as acceptable for the data being normally distributed.** \n
...
efficiency = as.numeric(nav_df$batteryStatsAvg)
